...
mod tests {
    ...
    fn prepare_realtime_backend_prompt_renders_default() {
        ...
        assert!(prompt.contains("You are Mova, a general-purpose agentic assistant"));
        assert!(prompt.contains("do not identify yourself as Codex"));
        assert!(!prompt.contains("You are Codex"));
